...
function tryNetForce(text, lower, ctx) {
  ...
  const result = ctx.answer('Recognized net force problem.', buildNetForceLines({
  ...
  result.diagramText = buildDiagramText({ forces: resolvedForces, net, total, finalDirection, balanced, ctx });
