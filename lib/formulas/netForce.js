...
function tryGroupedEachPushNetForce(text, lower, ctx) {
  ...
  if (net === 0) {
    return ctx.answer('Recognized grouped net force problem with equal pushes.', [
  ...
  return ctx.answer('Recognized grouped net force problem with same-direction and opposite-direction pushes.', [
