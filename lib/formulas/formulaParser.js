...
const ACCEL_UNITS = [
  unit('m/s^2', 'm', 's', ['meters per second squared', 'meter per second squared', 'm/s^2', 'm/s²', 'm/s/s', 'm/sec/sec', 'm/sec^2', 'm/sec²', 'm/sec2']),
  unit('ft/s^2', 'ft', 's', ['feet per second squared', 'foot per second squared', 'ft/s^2', 'ft/s²', 'ft/s/s', 'ft/sec/sec', 'ft/sec^2', 'ft/sec²', 'ft/sec2'])
];
