...
function tryMassFormulaClarification(lower) {
  ...
  return answer('Recognized ambiguous formula question: solving for mass.', [
    'Which values do you have? If you have density and volume, use mass = density × volume. If you have force and acceleration, use mass = force ÷ acceleration. If you have kinetic energy and velocity, use mass = 2KE ÷ velocity².'
  ]);
}
