...
function tryCircuitResistance(text, lower) {
  ...
  const branchCurrentRequest = circuitType === 'parallel' ? findParallelBranchCurrentRequest(text, lower, voltage) : null;
...
function findParallelBranchCurrentRequest(text, lower, voltage) {
...
function buildElectricalPowerFormulaWork({ solveFor, voltageValue, currentValue, powerValue }) {
