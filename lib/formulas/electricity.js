...
function ambiguousVoltageCurrentQuestion(text, lower) {
  ...
  if (asksForOhmsTarget(lower, 'voltage|volt|volts|v')) return null;
  ...
  return buildFormulaWork({
    ...
    calculation: {
      prompt: solveFor === 'voltage'
        ? `Now substitute: V = ${cleanNumber(currentValue)} × ${cleanNumber(resistanceValue)}. What is ${cleanNumber(currentValue)} × ${cleanNumber(resistanceValue)}?`
        : solveFor === 'current'
          ? `Now substitute: I = ${cleanNumber(voltageValue)} / ${cleanNumber(resistanceValue)}. What is ${cleanNumber(voltageValue)} / ${cleanNumber(resistanceValue)}?`
          : `Now substitute: R = ${cleanNumber(voltageValue)} / ${cleanNumber(currentValue)}. What is ${cleanNumber(voltageValue)} / ${cleanNumber(currentValue)}?`,
  ...
  return {
    ...
    steps: [
      ...
      },
      {
        id: 'calculate',
        type: 'calculation',
        prompt: `Now substitute: V = ${cleanNumber(currentValue)} × ${cleanNumber(resistanceValue)}. What is ${cleanNumber(currentValue)} × ${cleanNumber(resistanceValue)}?`,
