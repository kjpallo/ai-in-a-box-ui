const formulaRegistry = [
  {
    ...
    variables: ['displacement', 'final position', 'initial position', 'direction'],
    solveFor: ['displacement'],
    units: ['m', 'km', 'mile', 'ft', 'cm'],
    examples: [
      'An object starts at 2 m and ends at 10 m. What is its displacement?',
      'A person walks 10 m east, then 4 m west. What is the displacement?'
    ]
  },
  {
    id: 'motion',
