...
function buildMotionFormulaWork({ solveFor, distanceValue, distanceUnit, timeValue, timeUnit, speedValue, speedUnit, answerKind = 'speed', direction = '', finalDisplay = '', extraFinalAnswers = [], ctx }) {
