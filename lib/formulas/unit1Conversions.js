  ...
  methodStep.branchPaths = [
    ...
    },
    {
      ...
      steps: [
        ...
        compactTextStep('cancel_units', 'Click a unit that cancels, or type one.', parsed.startUnit),
...
function tryPicketFenceConversion(text, lower) {
  ...
  const formulaWork = buildConversionFormulaWork({
    ...
    steps: [
      ...
      ...factorSteps,
      compactTextStep('cancel_units', 'Click a unit that cancels, or type one.', cancellationUnits[0], cancellationUnits),
  ...
  sections.push(
    {
      ...
      unlockAfterStepIds: ['cancel_units']
    },
    {
      id: 'top_product',
      label: 'Top product',
...
function compactTextStep(id, prompt, expected, accepted = []) {
