...
function buildOriginalVelocityFields({ originalValue, originalUnit, convertedValue, convertedDisplay, targetUnit, label, ctx }) {
  ...
  return {
    ...
    conversionReminder: `We will use ${convertedDisplay} for ${label} in the formula.`
  };
}
