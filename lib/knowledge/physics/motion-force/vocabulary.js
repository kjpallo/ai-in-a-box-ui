const vocabulary = [
  ...
  },
  {
    ...
    "definition": "Drag, a force that resists motion through air. It depends on speed, shape/frontal area/surface area, and air or fluid conditions.",
    "commonMisconception": "Ignoring speed, shape, surface area, or air/fluid conditions when comparing falling objects.",
    "exampleCue": "A flat sheet of paper falls slower than a crumpled paper ball.",
    "examples": [
      "A faster-moving object usually has more air resistance.",
      "A wider or flatter shape usually has more air resistance than a streamlined shape."
    ],
  ...
  },
  {
    ...
    "definition": "Motion where gravity is the only force acting; near Earth it has constant acceleration of about 9.8 m/s² downward.",
    "commonMisconception": "Saying a freely falling object has constant velocity instead of constant acceleration.",
    "exampleCue": "Ignoring air resistance, a dropped ball accelerates downward at about 9.8 m/s².",
    "sourcePages": "22,25,31"
  },
  {
    "id": "normal_force",
    ...
    "definition": "A support force exerted perpendicular to a surface; a chair pushes upward on a person standing on it.",
    "commonMisconception": "Forgetting the normal force balances weight when an object is supported and not accelerating vertically.",
    "exampleCue": "A chair exerts an upward normal force on a person standing still.",
  ...
  },
  {
    ...
    "aliases": [
      "mass times velocity",
      "amount of force needed to change motion"
    ],
    "definition": "Mass in motion, found by multiplying mass by velocity.",
    "commonMisconception": "For this class key, 'related to the force needed to change motion' points to momentum, while 'tendency to resist changes in motion' is inertia.",
