const concepts = [
  ...
  },
  {
    ...
    "needsRouterSupport": [
      ...
      "answer air-resistance factor questions with speed, shape/frontal area/surface area, and air/fluid conditions",
      "answer friction factor-and-type bonus prompts with roughness/type of surface, normal force, class-key surface area, and static/sliding/rolling friction."
    ],
  ...
  },
  {
    ...
    "needsRouterSupport": [
      ...
      "identify free fall as constant acceleration due to gravity",
      "answer support-force questions as upward normal force when weight is balanced."
    ],
  ...
  },
  {
    ...
    "needsRouterSupport": [
      ...
      "explain bowling ball vs tennis ball same-acceleration prompts as more mass needing more force."
    ],
  ...
  },
  {
    ...
    "needsRouterSupport": [
      ...
      "preserve class-key distinction: force needed to change motion = momentum, tendency to resist change = inertia."
    ],
