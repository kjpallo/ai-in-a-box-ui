...
const UNIT6_MATTER_FACTS = [
  ...
  matterFact('density_property', 'definition', 'density', 'Density is mass per unit volume, or D = m / V. Common units are g/cm3 and g/mL. Density is a physical property and does not change with sample size.', { category: 'density', aliases: ['mass per unit volume', 'D = m / V'], smokePrompt: 'what is density' }),
