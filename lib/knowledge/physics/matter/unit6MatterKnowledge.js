...
function answerMatterConcept(text) {
  ...
  if (asksDensityIdentifySubstance(text)) {
    return concept('density_identifies_substance', 'Density helps identify a substance because it is a characteristic physical property. A pure substance has the same density no matter the sample size.');
  }
