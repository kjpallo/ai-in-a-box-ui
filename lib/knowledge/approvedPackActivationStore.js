...
function removeApprovedPackActivation(packId, options = {}) {
  assertSafePackId(packId);
  const state = loadApprovedPackActivation(options);
  const hadActivation = Object.prototype.hasOwnProperty.call(state.packs, packId);
  if (hadActivation) {
