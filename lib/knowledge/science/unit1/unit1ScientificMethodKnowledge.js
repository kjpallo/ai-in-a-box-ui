...
function matchNarrowScenario(text) {
  const asksIndependent = /\bindependent variable\b/.test(text);
  const asksDependent = /\bdependent variable\b/.test(text);
