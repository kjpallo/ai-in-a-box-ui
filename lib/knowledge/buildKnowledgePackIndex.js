...
function indexVocabulary(items, packContext, index) {
  ...
  items.forEach((item) => {
    ...
    const entry = makeIndexEntry(packContext, 'vocabulary', item, getLinkedStandardIds(item));
...
function indexConcepts(items, packContext, index) {
  ...
  items.forEach((item) => {
    ...
    const entry = makeIndexEntry(packContext, 'concept', item, getLinkedStandardIds(item));
...
function indexProblemBank(items, packContext, index) {
  ...
  items.forEach((item) => {
    ...
    const entry = makeIndexEntry(packContext, 'problem', item, getLinkedStandardIds(item));
