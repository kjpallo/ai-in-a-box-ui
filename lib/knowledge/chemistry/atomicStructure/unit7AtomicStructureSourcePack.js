...
const UNIT7_COMPARISON_PAIRS = [
  ...
  comparison({
    id: 'unit7.compare.isotope.ion',
    concepts: ['isotope', 'ion'],
    left: 'isotope',
    right: 'ion',
    same: 'Both terms describe atoms by how their subatomic particle counts differ from a reference atom.',
    differences: [
      'An isotope is the same element with a different number of neutrons; its proton count stays the same.',
      'An ion is an atom with unequal proton and electron counts because electrons were gained or lost.'
    ],
    sourceRefs: ['Concept 2 Notes - Isotopes.pptx', 'Packet KEY - Atomic Structure Honors.pdf']
  }),
  comparison({
