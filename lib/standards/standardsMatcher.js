...
function scoreBankStandard(standard, normalizedQuestion, questionTokens, conceptScoreById, profile) {
  ...
  if (
    standard.standardId === '9-12.PS2.A.1' &&
    questionTokens.includes('force') &&
    questionTokens.includes('mass') &&
    questionTokens.includes('acceleration')
  ) {
    rawScore += 13;
    matchedReasons.push('exactTrigger');
    evidence.exactTrigger += 1;
  }
