...
const STANDARD_CATEGORY_CLUES = {
  forces: {
    keywords: [
      ...
      'collision', 'momentum', 'net force', 'velocity', 'inertia'
    ],
    whyThisMatters: 'This matters because it helps explain car crashes, seatbelts, sports, ramps, and why heavier objects are harder to speed up or stop.'
  },
  energy: {
    keywords: [
  ...
  matter: {
    ...
    whyThisMatters: 'This matters because the structure of atoms explains why materials behave differently, like why metals conduct electricity, why salt dissolves, or why some substances react.'
  },
  life: {
    keywords: [
...
function answerStandardsFollowUp(message, contextQuestion, options = {}) {
  ...
  const clarificationCandidates = getClarificationCandidates(match, previousQuestion);
  ...
  return matches
    .map((match, index) => {
      ...
      return {
        ...
        answer: formatStandardsAnswer(standard, context),
