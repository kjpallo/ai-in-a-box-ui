function buildKnowledgePackPrompt(options = {}) {
  ...
  return [
    ...
    '- Every generated vocabulary, concept, referenceFormula, problemBank item, standardsMap item, and smokeTest must include standards metadata with linkedStandardIds: [], suggestedStandardIds: [], alignmentStatus: "not_aligned_yet", and alignmentSource: "none".',
    '- Do not auto-align generated draft items to standards yet.',
    '- Do not put invented, guessed, or bank IDs into generated item standards metadata.',
    ...
    standardsList.length > 0
      ? [
          ...
          '',
          'Standards rules:',
          '- You may only use standardIds from the available standards bank above in standardsMap entries.',
          '- Keep generated item standards metadata empty and not_aligned_yet in this phase.',
          '- If no listed standard is clearly supported by the extracted text, leave standardsMap empty.',
      ...
      : [
          ...
          '- Prefer an empty standardsMap and empty standards metadata.',
