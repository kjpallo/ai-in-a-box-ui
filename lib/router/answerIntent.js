...
function normalize(value) {
  ...
  return String(value || '')
    ...
    .replace(/[’`]/g, "'")
    .replace(/\s+/g, ' ')
    .replace(/\b(?:vloume|volme|volum|denisty|dencity|dinsity|densitty|densaty|desity|accelleration|accleration|resitance|eletrical)\b/g, (term) => typoMap.get(term) || term)
    .trim();
}
