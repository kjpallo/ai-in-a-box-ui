...
const KNOWN_COMPARISON_PAIRS = [
  ...
  },
  {
    ...
    concepts: [
      ...
      },
      {
        ...
        aliases: ['potential energy', 'gravitational potential energy']
      }
    ],
  ...
  },
  {
    ...
    concepts: [
      {
        knowledgeId: 'mass-definition',
        label: 'mass',
        aliases: ['mass']
      },
      {
        knowledgeId: 'weight-definition',
        label: 'weight',
        aliases: ['weight']
      }
    ],
    relationship: 'Mass and weight are related because an object with mass can have weight when gravity pulls on it.',
    difference: 'The simple difference is that mass is the amount of matter and stays the same when gravity changes, while weight is a force that can change when gravity changes.'
  },
  {
    ...
    concepts: [
      {
        label: 'distance',
        aliases: ['distance'],
        localFact: 'Distance is the total length traveled, no matter which direction something moves.'
      },
      {
        label: 'displacement',
        aliases: ['displacement'],
        localFact: 'Displacement is how far and in what direction something is from where it started.'
      }
    ],
