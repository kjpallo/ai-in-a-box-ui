    ...
    concepts: [
      {
        ...
        label: 'mass',
        aliases: ['mass'],
        localFact: 'Mass is the amount of matter in an object and stays the same when gravity changes.'
      },
      {
        knowledgeId: 'weight-definition',
        label: 'weight',
        aliases: ['weight'],
        localFact: 'Weight is the force of gravity pulling on an object and can change when gravity changes.'
      }
    ],
