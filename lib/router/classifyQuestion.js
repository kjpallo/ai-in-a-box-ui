...
function applyRoutingAliases(value) {
  return String(value || '')
    .replace(/\b(what\s+is|what\s+are|define|meaning\s+of|what\s+does)(?=(?:acceleration|friction|force|reference|motion|speed|velocity|distance|displacement|inertia)\b)/g, '$1 ')
