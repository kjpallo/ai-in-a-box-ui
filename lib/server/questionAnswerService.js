...
function sanitizeGraphContext(context) {
  const matchedNodes = sanitizeGraphNodes(context?.matchedNodes, 8);
  const relatedNodes = sanitizeGraphNodes(context?.relatedNodes, 10);
  const edges = sanitizeGraphEdges(context?.edges, 14);
