    ...
    steps: [
      {
        ...
        type: 'choice',
        prompt: "Which Newton's law best matches the clue?",
        choices: [
          {
            number: 1,
        ...
        correctAnswer: law,
        hints: [
          "First is about keeping motion, second connects force, mass, and acceleration, and third is about force pairs.",
...
function getNewtonsLawsFinalAnswer(law) {
  if (law === 'third') {
    return "That is Newton's Third Law: forces come in action-reaction pairs.";
  }
  if (law === 'second') {
    return "That is Newton's Second Law: force, mass, and acceleration are connected.";
  }
  return "That is Newton's First Law: objects stay at rest or keep moving unless a force changes their motion.";
}

function getNewtonsLawsStrongerHint(law) {
  if (law === 'third') return "Choose Newton's Third Law for action-reaction or equal-and-opposite force pairs.";
  if (law === 'second') return "Choose Newton's Second Law when the clue connects force, mass, and acceleration.";
  return "Choose Newton's First Law when the clue is about staying at rest, keeping motion, or inertia.";
}
